...
Tuples indexing, Mapping values to individual variables (unpacking)
Joining strings using join
type casting of list(),str(),tuple()

surprised at first sight when i got int instead of tuple and then understood :)
Noted the awkward syntax for single tuple
"""
