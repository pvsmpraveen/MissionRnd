...
def test_equality():
    ...
    assert True == (0 == False) # what happened here?  Ans : 0 is treated as False, so False==False is True
    assert True == (1 == True)
    assert False == ("a" == True)
...
-Various base cases of true,false
-condition checking with statements
-Nonetype
"""
