...
exports.ConvertDateToString = function(dateValue){
	if(dateValue==null || !(dateValue instanceof Date)) return null;
	var arr = dateValue.toString().split(" ");
	var res = arr[0]+" "+arr[1]+" "+arr[2]+" "+arr[3];
	return res;
}
...
exports.ParseStringOfNumbers = function(str){
	if(str==null || str=="" || typeof(str)!="string") return new Array();
	var arr = str.split(",");
